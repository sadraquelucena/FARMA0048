...
:::{.column width="50%"}
#### Sem Interação
*(Efeitos aditivos / Linhas paralelas)*
- O comportamento do Fator A é o mesmo em todos os níveis do Fator B.
:::

:::{.column width="50%"}
#### Com Interação
*(Efeitos não aditivos / Linhas se cruzam)*
- O efeito do Fator A muda significativamente conforme o nível do Fator B.
:::
::::
...
Um laboratório avaliou a **taxa de permeabilidade** (\(10^{-6}\text{ cm/s}\)) de um insumo farmacêutico ativo utilizando duas variáveis experimentais:

- **Fator 1 (Formulação):** Com Promotor de Absorção vs. Controle
- **Fator 2 (Segmento Intestinal):** Duodeno vs. Íleo

Foram utilizadas 8 amostras para cada combinação dos fatores (\(2 \times 2 = 4\) grupos; \(n = 32\)).

- **Perguntas de pesquisa:**
  1. Existe interação entre a Formulação e o Segmento Intestinal?
  2. A permeabilidade difere entre as formulações?
  3. A permeabilidade difere entre os segmentos intestinais?
...
:::{.column width="50%"}
<p align="center">
<img src="imagens/anova_2fatores_jamovi1.png" width="600">
</p>
...
<p align="center">
<img src="imagens/anova_2fatores_jamovi2.png" width="600">
</p>
